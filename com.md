...
###协作过程
<iframe id="embed_dom" name="embed_dom" frameborder="0" style="border:1px solid #000;display:block;width:1024px; height:768px;" src="http://www.processon.com/embed/53b8e6fc0cf2a66684a6225b"></iframe>
1. 建模
	1. 建模者设计并发布本模型。
